...
def sync_vulnerabilities(background_tasks: BackgroundTasks):
    """
    Trigger manual NVD synchronization (runs in background).
    Returns 202 immediately; the actual sync runs asynchronously.
    """
    def _do_sync():
    ...
    return {"status": "started", "message": "Sync NVD iniciado em background. Acompanhe nos logs do backend."}
