    ...
    return (
        <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4">
                {loading ? (
                    <div className="text-center py-20 text-gray-500 animate-pulse">Carregando feed de inteligência...</div>
                ) : (
                        ...
                        <div key={i} className="glass-panel p-6 rounded-lg flex gap-6 hover:bg-white/5 transition-colors group">
                            ...
                            <div className="flex-1">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 text-sm text-white hover:text-cyber-accent transition-colors"
                                >
