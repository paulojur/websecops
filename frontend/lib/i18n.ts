...
export const translations = {
  pt: {
    ...
    noTechIdentified: 'Nenhuma tecnologia identificada.',
    dastScanHistory: 'Histórico de Scans (DAST)',
    scanDate: 'Data do Scan',
    scanType: 'Tipo',
    criticalCount: 'Críticos',
    highCount: 'Altos',
    mediumCount: 'Médios',
    prioritizedRisks: 'Riscos Priorizados',
    congratulationsNoCVE: 'Parabéns! Nenhuma CVE recente encontrada para as tecnologias deste alvo.',
    howToFix: 'Como corrigir',
    whyItMattersLabel: 'Por que importa',
    confidenceLabel: 'Confiança',
    nextStepLabel: 'Próximo passo',
    reportTextTitle: 'Texto para relatório',
    riskLabel: 'Risco',
    evidenceLabel: 'Evidência',
    impactLabel: 'Impacto',
    recommendation: 'Recomendação',
    recommendedHardening: 'Hardening recomendado',
    backButton: 'Voltar',
    searchErrorTitle: 'Erro na Busca',
    fetchingCVEsRealtime: 'Buscando CVEs em tempo real...',
    readingLocalDemo: 'Lendo o demo local salvo no navegador.',
    queryingNVDAPI: 'Consultando a API do NVD para o alvo',
  ...
  en: {
    ...
    noTechIdentified: 'No technologies identified.',
    dastScanHistory: 'Scan History (DAST)',
    scanDate: 'Scan Date',
    scanType: 'Type',
    criticalCount: 'Critical',
    highCount: 'High',
    mediumCount: 'Medium',
    prioritizedRisks: 'Prioritized Risks',
    congratulationsNoCVE: 'Congratulations! No recent CVEs found for this target\'s technologies.',
    howToFix: 'How to Fix',
    whyItMattersLabel: 'Why it matters',
    confidenceLabel: 'Confidence',
    nextStepLabel: 'Next step',
    reportTextTitle: 'Report Text',
    riskLabel: 'Risk',
    evidenceLabel: 'Evidence',
    impactLabel: 'Impact',
    recommendation: 'Recommendation',
    recommendedHardening: 'Recommended Hardening',
    backButton: 'Back',
    searchErrorTitle: 'Search Error',
    fetchingCVEsRealtime: 'Searching CVEs in real-time...',
    readingLocalDemo: 'Reading local demo saved in browser.',
    queryingNVDAPI: 'Querying NVD API for target',
